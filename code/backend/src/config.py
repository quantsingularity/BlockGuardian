...
class Config:
    ...
    def database(self) -> DatabaseConfig:
        ...
        return DatabaseConfig(
            uri=os.environ.get('DATABASE_URL', 'postgresql://postgres:postgres@localhost:5432/blockguardian'),
    ...
    def compliance(self) -> ComplianceConfig:
        ...
        return ComplianceConfig(
            ...
            transaction_reporting_enabled=os.environ.get('TRANSACTION_REPORTING_ENABLED', 'true').lower() == 'true',
...
class DevelopmentConfig(Config):
    ...
    def database(self) -> DatabaseConfig:
        ...
        config.uri = os.environ.get('DATABASE_URL', f"sqlite:///{os.path.join(os.path.dirname(__file__), 'database', 'app.db')}")
        config.echo = True
        return config
...
class ProductionConfig(Config):
    ...
    CORS_ORIGINS = os.environ.get('CORS_ORIGINS', '').split(',') if os.environ.get('CORS_ORIGINS') else ["https://blockguardian.com"]
