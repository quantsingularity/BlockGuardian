...
class TestComplianceManager(TestCase):
    ...
    def test_perform_kyc_verification_failed_step(self, mock_get_session):
        ...
        with patch.object(
            ...
            self.assertTrue(
                any(
                    step["status"] == "failed" for step in result["verification_steps"]
                ),
    ...
    def test_verify_identity_name_mismatch(self):
        ...
        documents = [
            {"type": "government_id", "name": "Jane Smith"}  # Different from test user
        ]
    ...
    def test_calculate_kyc_risk_score_high_risk(self):
        ...
        self.test_user.created_at = datetime.now(timezone.utc) - timedelta(
            hours=12
        )  # New account
    ...
    def test_assess_user_transaction_risk_vs_income(self):
        ...
        self.test_transaction.total_amount = Decimal(
            "10000"
        )  # High transaction vs income
    ...
    def test_generate_sar(self, mock_get_session):
        ...
        self.assertIsInstance(
            sar_call, Mock
        )  # Would be SuspiciousActivity in real implementation
