...
from src.models.portfolio import Portfolio, Asset, PortfolioHolding, Transaction, AssetType, PortfolioType, TransactionType, TransactionStatus
...
class TestPortfolioCreation:
    ...
    def test_create_portfolio_success(self, client, authenticated_user, sample_portfolio_data):
    ...
    def test_create_portfolio_invalid_type(self, client, authenticated_user, sample_portfolio_data):
...
class TestPortfolioManagement:
    ...
    def test_get_portfolio_by_id(self, client, authenticated_user, sample_portfolio_data):
    ...
    def test_get_portfolio_unauthorized(self, client, authenticated_user, sample_portfolio_data):
...
class TestAssetManagement:
    ...
    def test_filter_assets_by_type(self, client, authenticated_user):
        ...
        response = client.get('/api/portfolios/assets?asset_type=stock', headers=headers)
...
class TestPortfolioHoldings:
    ...
    def test_get_portfolio_holdings(self, app, client, authenticated_user, sample_portfolio_data):
        ...
        # Get holdings
        response = client.get(f'/api/portfolios/{portfolio_id}/holdings', headers=headers)
    ...
    def test_get_portfolio_performance(self, app, client, authenticated_user, sample_portfolio_data):
        ...
        # Get performance
        response = client.get(f'/api/portfolios/{portfolio_id}/performance', headers=headers)
...
class TestTransactions:
    ...
    def test_create_buy_transaction(self, app, client, authenticated_user, sample_portfolio_data):
        ...
        response = client.post(f'/api/portfolios/{portfolio_id}/transactions',
    ...
    def test_create_sell_transaction_insufficient_holdings(self, app, client, authenticated_user, sample_portfolio_data):
    ...
    def test_get_transaction_history(self, app, client, authenticated_user, sample_portfolio_data):
        ...
        response = client.get(f'/api/portfolios/{portfolio_id}/transactions', headers=headers)
    ...
    def test_cancel_pending_transaction(self, app, client, authenticated_user, sample_portfolio_data):
        ...
        # Cancel transaction
        response = client.post(f'/api/portfolios/{portfolio_id}/transactions/{transaction_id}/cancel',
                             headers=headers)
...
class TestPortfolioAnalytics:
    ...
    def test_portfolio_allocation(self, app, client, authenticated_user, sample_portfolio_data):
        ...
        # Get allocation
        response = client.get(f'/api/portfolios/{portfolio_id}/allocation', headers=headers)
    ...
    def test_portfolio_risk_metrics(self, client, authenticated_user, sample_portfolio_data):
