...
const recommendations = [
    {
        ...
        description: 'AI analysis suggests potential growth in decentralized finance protocols.',
        risk: 'Medium',
        icon: 'cash-outline',
    },
    {
    ...
    },
    {
        ...
        description: 'Based on recent on-chain activity and market sentiment, XYZ shows potential.',
        risk: 'High',
    ...
    const renderRecommendation = (item) => (
        ...
        >
            <StyledView className="flex-row items-center mb-2">
                ...
                <StyledText className="text-lg font-semibold text-white flex-1" numberOfLines={1}>
                    {item.title}
                </StyledText>
