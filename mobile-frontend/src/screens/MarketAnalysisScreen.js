  ...
  return (
    <StyledScrollView className="flex-1 bg-gradient-to-b from-gray-900 to-gray-800">
      <StyledView className="p-6 pt-12">
        <StyledText className="text-3xl font-bold text-white mb-8">Market Analysis</StyledText>

        {/* Market Overview Card */}
        <StyledView className="bg-gray-700 rounded-lg p-5 mb-6 shadow-md border border-gray-600">
          <StyledView className="flex-row items-center mb-3">
            <Ionicons name="trending-up-outline" size={24} color="#4f46e5" style={{ marginRight: 10 }} />
            <StyledText className="text-xl font-semibold text-white">Market Overview</StyledText>
          </StyledView>
          ...
          <StyledText className="text-gray-400">Key market indicators and overall sentiment will be displayed here.</StyledText>
        </StyledView>

        {/* Trend Analysis Card */}
        <StyledView className="bg-gray-700 rounded-lg p-5 mb-6 shadow-md border border-gray-600">
          <StyledView className="flex-row items-center mb-3">
            <Ionicons name="pulse-outline" size={24} color="#4f46e5" style={{ marginRight: 10 }} />
            <StyledText className="text-xl font-semibold text-white">Trend Analysis</StyledText>
          </StyledView>
        ...
        <StyledView className="bg-gray-700 rounded-lg p-5 shadow-md border border-gray-600">
          <StyledView className="flex-row items-center mb-3">
            <Ionicons name="rocket-outline" size={24} color="#4f46e5" style={{ marginRight: 10 }} />
            <StyledText className="text-xl font-semibold text-white">Top Movers</StyledText>
          </StyledView>
