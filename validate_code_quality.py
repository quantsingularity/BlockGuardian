...
def check_python_code():
    ...
    print("\n=== Running Flake8 ===")
    success, output = run_command("flake8 --max-line-length=100 --exclude=venv,__pycache__ .", cwd="backend")
...
def check_smart_contracts():
    ...
    print("\n=== Running Solhint ===")
    success, output = run_command("solhint 'contracts/**/*.sol'", cwd="blockchain-contracts")
    print(output if output else "No linting issues found.")
