...
describe('Navbar Component', () => {
  ...
  test('toggles mobile menu visibility', () => {
    ...
    expect(screen.getByRole('button', { name: /Open main menu/i }).querySelector('svg path[d="M6 18L18 6M6 6l12 12"]')).toBeInTheDocument();
    ...
    expect(screen.getByRole('button', { name: /Open main menu/i }).querySelector('svg path[d="M4 6h16M4 12h16M4 18h16"]')).toBeInTheDocument();
