      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Explore blockchain transactions, smart contracts, and real-time
            network activity.
          </p>
        </div>
        ...
        <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl shadow-lg p-6 mb-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Connect your Ethereum wallet to interact with smart contracts and
              manage your assets.
            </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Automated, self-executing contracts with the terms directly
                written into code, eliminating intermediaries.
              </p>
            </div>
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              <div className="flex items-center mb-3">
