      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl mb-8 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            organizations protect their blockchain assets, detect
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Advanced machine learning models for financial prediction and
              portfolio optimization with LSTM, GARCH, and PCA implementations.
            </p>
            <Link
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Secure transactions with Ethereum smart contracts and transparent
              ledger technology for trustless trading and settlement.
            </p>
            <Link
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Live financial data streaming with advanced visualization and
              insights powered by WebSockets and real-time analytics.
            </p>
            <Link
        ...
        <div className="bg-indigo-50 dark:bg-gray-800 rounded-2xl p-8 mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              unparalleled insights and performance for your investments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Predictive analytics and market sentiment analysis to stay
